...
cd ..
mkdir -p ${ns_repo_location}/packages/sina
cp ${SCRIPT_DIR}/package.py ${ns_repo_location}/packages/sina/
$SPACK setup ${repo_namespace}.sina@develop%${SPACK_COMPILER} ${@:1}
